    ...
    <div className="min-h-screen bg-background pb-20 relative">
      ...
      <div className="relative z-10 px-5 space-y-5">
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            { label: t("astral.label_sun"), sign: astrology.sunSign.sign, element: astrology.sunSign.element, color: "#D4A017" },
            { label: t("astral.label_moon"), sign: astrology.moonSign.sign, element: astrology.moonSign.element, color: "#8B5CF6" },
            { label: t("astral.label_ascendant"), sign: astrology.ascendant.sign, element: astrology.ascendant.element, color: "#60A5FA" },
          ].map((item) => (
            <motion.div
              key={item.label}
        ...
        <div className="border-glow rounded-xl bg-card/60 p-4">
          <h3 className="font-serif text-lg mb-3">{t("astral.positions_title")}</h3>
        ...
        {/* Aspects */}
        <div className="border-glow rounded-xl bg-card/60 p-4">
          <h3 className="font-serif text-lg mb-3">{t("astral.aspects_title")}</h3>
        ...
        {/* Houses */}
        <div className="border-glow rounded-xl bg-card/60 p-4">
          <h3 className="font-serif text-lg mb-3">{t("astral.houses_title")}</h3>
