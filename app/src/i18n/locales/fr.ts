...
const fr: UiStrings = {
  ...
  "profile_boundary.title": "Complète ton profil pour cette lecture",
  "profile_boundary.description": "Cette partie utilise ton prénom et ta date de naissance. Tu peux les enregistrer une fois, ou continuer directement avec l'Oracle sans profil.",
  "profile_boundary.complete": "Compléter mon profil",
  "profile_boundary.use_oracle": "Continuer avec l'Oracle",
  "profile_boundary.error_title": "Ton profil ne répond pas",
  "profile_boundary.error_desc": "Nous n'avons pas pu vérifier tes informations. Réessaie sans risquer d'afficher des données incorrectes.",
  "onboarding.progressive_title": "Ton profil, en 20 secondes",
  "onboarding.progressive_subtitle": "Ton prénom et ta date suffisent. Tu pourras ajouter ou modifier le reste plus tard.",
  "onboarding.progressive_advanced_title": "Affiner mon profil, facultatif",
  "onboarding.progressive_advanced_desc": "Heure, lieu, noms et préférences",
  "onboarding.progressive_save": "Enregistrer et continuer",
  "onboarding.progressive_skip": "Continuer sans profil",
  "onboarding.progressive_skip_explanation": "Tu peux passer cette étape. Sans profil, les réponses seront moins personnalisées et certaines informations pourront t'être redemandées. Tu pourras le compléter à tout moment.",
  "dashboard.greeting_generic": "Bienvenue dans ton espace",
  "dashboard.profile_prompt_title": "Explore à ton rythme",
  "dashboard.profile_prompt_desc": "Complète ton profil pour débloquer les lectures personnelles, ou parle tout de suite à l'Oracle sans renseigner d'informations.",
  "oracle.pass_offer_title": "48 h Étoile offertes",
  "oracle.pass_offer_desc": "Active ton Pass pour parler à l'Oracle sans la limite gratuite habituelle : jusqu'à 20 messages par heure et 100 au total.",
  "oracle.pass_activate": "Activer mes 48 h",
  "oracle.pass_no_card": "Sans carte bancaire. Le délai commence après ton clic.",
  "oracle.pass_active_title": "Ton Pass Étoile est actif",
  "oracle.pass_active_desc": "L'Oracle est disponible sans la limite gratuite habituelle, jusqu'à 20 messages par heure et 100 au total pendant le Pass.",
  "oracle.pass_remaining": "Encore {time}",
  "oracle.pass_fair_use_reached": "Tu as atteint la limite d'usage raisonnable de ton Pass. Réessaie un peu plus tard : ton Pass reste actif.",
  ...
  "oracle.signup_wall_title": "Continue avec une réponse vraiment personnelle",
  "oracle.signup_wall_text": "Crée gratuitement ton profil pour retrouver cette conversation et recevoir la suite personnalisée à ta question.",
  "oracle.signup_wall_cta": "Créer mon profil gratuit et continuer",
  "oracle.pending_title": "Ta question est gardée",
  "oracle.pending_text": "Tu pourras la modifier ou l'envoyer quand tu reviendras.",
  "oracle.pending_available_today": "Nouvelle question disponible à {time}",
  "oracle.pending_available_tomorrow": "Nouvelle question disponible demain à {time}",
  "oracle.pending_modify": "Modifier ma question",
  "oracle.pending_explore_profile": "Explorer mon profil",
  "oracle.pending_delete": "Supprimer",
  "oracle.pending_send": "Envoyer ma question",
