...
FROM = alertes@mail.karmastro.com (domaine verifie Resend; onboarding@resend.dev ne livre plus qu'au owner
...
FROM_EMAIL = "alertes@mail.karmastro.com"
TO_EMAIL = "augustin.foucheres@gmail.com"
REPO = "STACK-2026/karmastro"
...
def main() -> int:
    ...
    subject = f"[karmastro] Deploy FAIL : {workflow}"
...
<p>Cause probable : contenu non conforme au schema (category hors enum, source url:"", champ requis manquant) ou content guard. Voir le log du step "Build Astro site".</p>
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "KarmastroAlerts/1.0",
        },
        method="POST",
    )
    try:
