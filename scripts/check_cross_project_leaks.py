...
SELF_PROJECT = {
    "name": 'karmastro',
    "supabase_ref": 'nkjbmbdrvejemzrggxvr',
    "domain": 'karmastro.com',
    "cf_pages_project": 'karmastro',
    "own_tokens": {'Karmastro', 'karmastro', 'karmastro.com'},
    "own_domains": {'karmastro.com'},
    "own_supabase_refs": {'nkjbmbdrvejemzrggxvr'},
}
