...
BRIEF_PROMPT_TEMPLATE = """Tu es un strategiste SEO et GEO (Generative Engine Optimization) specialise en niche : astrologie, numerologie, spiritualite, developpement personnel.
...
REQUETE : "{keyword}"
MARCHE CIBLE : France + 9 langues (EN/DE/IT/PT/ES/TR/PL/RU/AR/JA), lecteurs grand public
NOTRE POSITIONNEMENT : Karmastro, plateforme astrologique premium, rapports complets, theme astral + numerologie + karmique
