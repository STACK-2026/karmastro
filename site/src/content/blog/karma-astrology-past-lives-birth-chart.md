...
author: "Orion"
category: "karma"
tags: ["karma", "past lives", "astrology", "spiritual", "lunar nodes"]
keywords: "karma, past lives, astrology, spiritual, lunar nodes"
draft: false
lang: "en"
...
| South Node → North Node | Soul lesson |
|-------------------------|-------------|
| Aries → Libra | From the solitary "I" to balanced partnership |
| Taurus → Scorpio | From material stability to deep transformation |
| Gemini → Sagittarius | From intellectual scattering to the search for meaning |
| Cancer → Capricorn | From protective family to public accomplishment |
| Leo → Aquarius | From personal ego to collective service |
| Virgo → Pisces | From controlling analysis to spiritual surrender |
| Libra → Aries | From fusion with the other to self-assertion |
| Scorpio → Taurus | From transformative intensity to embodied peace |
| Sagittarius → Gemini | From absolute truth to open curiosity |
| Capricorn → Cancer | From cold ambition to familial tenderness |
| Aquarius → Leo | From mental detachment to creative heart |
| Pisces → Virgo | From mystical escape to concrete presence |

To know the position of your lunar nodes, use our [birth chart calculator](/en/tools/birth-chart). They systematically appear in the report.
...
Astrology is not alone in speaking of karma. **[Karmic numerology](/en/tools/karmic-debt)** also offers specific indicators, notably the **karmic debts**: numbers appearing in your life path calculation and revealing memories of past incarnations requiring repair.
...
To detect if you carry a karmic debt, use our [karmic debt calculator](/en/tools/karmic-debt). It analyzes your birth date and automatically detects passages through 13, 14, 16, or 19 in the calculation.
...
- Our [birth chart calculator](/en/tools/birth-chart) to identify your lunar nodes and karmic positions
- Our [karmic debt calculator](/en/tools/karmic-debt) for the Pythagorean karmic numbers
- Our article on [birth chart interpretation](/en/blog/free-birth-chart-interpret-complete-natal-chart)
- Our article on [Saturn return](/en/blog/saturn-return-29-major-passage-into-adulthood) to go deeper on this key transit
...
No, not really. Astrological karma is read through the **lunar nodes**, **Saturn**, **Pluto**, the **twelfth house**, and the karmic aspects between planets. A sun sign alone is not enough at all. You need your full birth chart with the time of birth. Our [birth chart calculator](/en/tools/birth-chart) will give you all the elements.
