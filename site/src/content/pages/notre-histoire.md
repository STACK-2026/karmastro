...
description: "Comment une équipe passionnée d'astronomie et de mathématiques a créé Karmastro, la première plateforme française de guidance spirituelle de précision."
lastUpdated: 2026-04-10
---

## Tout a commencé par une frustration

On est une équipe de passionnés d'astronomie, de mathématiques et de spiritualité. Et on en avait marre.

Marre des horoscopes génériques qui disent la même chose à 600 millions de Bélier. Marre des sites de voyance qui facturent 100€ pour des prédictions vagues. Marre de la numérologie traitée comme de la magie alors que c'est un **système mathématique** documenté depuis Pythagore, au VIe siècle avant J.-C.
...
## Notre approche : le spirituel, rationnellement
...
**3. Le croisement multi-disciplines**
Aucun autre outil ne croise astrologie, numérologie et guidance karmique en une seule analyse. Quand l'Oracle te répond, il prend en compte tes positions planétaires exactes, ton chemin de vie, ton année personnelle, la phase lunaire du jour et les rétrogrades en cours. Tout calculé en temps réel.

## L'Oracle : pas un chatbot, un guide
...
La voyance en France représente entre 3,5 et 4 milliards d'euros par an, avec plus de 15 millions de consultations réalisées. 1 Français sur 3 consulte un voyant au moins une fois par an, et une consultation coûte en moyenne 25 à 100€.

Karmastro démocratise l'accès à une guidance de qualité, basée sur des calculs réels plutôt que sur l'intuition d'un inconnu au téléphone.

## Nos valeurs

- **Transparence** : on montre nos calculs, on cite nos sources, on explique nos raisonnements
- **Honnêteté** : quand on ne sait pas, on le dit. Quand une donnée manque, on l'indique
