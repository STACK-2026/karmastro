...
export type TranslationKeys = {
  ...
  // ===== Compatibility =====
  "compat.page_title": string;
  "compat.global_score": string;
  "compat.love": string;
  "compat.friendship": string;
  "compat.work": string;
  "compat.karma": string;
  "compat.tension": string;
  "compat.strengths": string;
  "compat.frictions": string;
  "compat.guidance": string;
  "compat.method_title": string;
  "compat.method_desc": string;
  "compat.precision_note": string;
  "compat.choose_sign": string;
  "compat.more_precise_title": string;
  "compat.more_precise_desc": string;
  "compat.synastry_cta": string;
  "compat.oracle_q": string;
  "compat.oracle_cta": string;
...
const fr: TranslationKeys = {
  ...
  "pricing.eveil_desc": "Profil cosmique complet, 2 consultations Oracle par jour, horoscope quotidien",
  "pricing.etoile_name": "Étoile",
  "pricing.etoile_desc": "Oracle illimité, mémoire des conversations et guidance mensuelle",
  ...
  "horoscope.personalised_cta_desc": "L'horoscope est une lecture générale. Pour une guidance qui prend en compte ton thème natal complet, pose ta question à l'Oracle.",
  ...
  "compat.page_title": "Compatibilité {s1} & {s2}",
  "compat.global_score": "Score global",
  "compat.love": "Amour",
  "compat.friendship": "Amitié",
  "compat.work": "Travail",
  "compat.karma": "Karma",
  "compat.tension": "Tension",
  "compat.strengths": "Forces de cette combinaison",
  "compat.frictions": "Points de friction",
  "compat.guidance": "Guidance karmique",
  "compat.method_title": "Méthode de calcul",
  "compat.method_desc": "Chaque compatibilité est calculée à partir des éléments (feu, terre, air, eau - 60%) et des modalités (cardinal, fixe, mutable - 40%) selon la tradition astrologique hellénistique.",
  "compat.precision_note": "Cette analyse donne une vue d'ensemble à ~30% de précision. Pour une synastrie à 85%, il faut croiser les 10 planètes et les ascendants des deux thèmes natals.",
  "compat.choose_sign": "Choisis ton signe",
  "compat.more_precise_title": "Tu veux une analyse 10x plus précise ?",
  "compat.more_precise_desc": "Les signes solaires ne couvrent que 30% de votre dynamique réelle. La synastrie complète croise les 10 planètes et les ascendants pour monter à 85% de précision.",
  "compat.synastry_cta": "Synastrie complète",
  "compat.oracle_q": "Analyse la compatibilité entre {s1} et {s2} : amour, amitié et karma. Qu'est-ce que ça révèle de notre couple ?",
  "compat.oracle_cta": "Demander à l'Oracle",
...
const en: TranslationKeys = {
  ...
  "pricing.eveil_desc": "Full cosmic profile, 2 Oracle consultations per day, daily horoscope",
  "pricing.etoile_name": "Star",
  "pricing.etoile_desc": "Unlimited Oracle, conversation memory and monthly guidance",
  ...
  "horoscope.personalised_cta_desc": "The horoscope is a general reading. For guidance that uses your complete birth chart, ask the Oracle.",
  ...
  "signs.pisces": "Pisces",
  "compat.page_title": "{s1} & {s2} Compatibility",
  "compat.global_score": "Global score",
  "compat.love": "Love",
  "compat.friendship": "Friendship",
  "compat.work": "Work",
  "compat.karma": "Karma",
  "compat.tension": "Tension",
  "compat.strengths": "Strengths of this combination",
  "compat.frictions": "Friction points",
  "compat.guidance": "Karmic guidance",
  "compat.method_title": "Calculation method",
  "compat.method_desc": "Each compatibility is calculated from elements (fire, earth, air, water - 60%) and modalities (cardinal, fixed, mutable - 40%) following the Hellenistic astrological tradition.",
  "compat.precision_note": "This analysis gives a general overview with ~30% precision. For 85% precision, a complete synastry crosses the 10 planets and ascendants of both birth charts.",
  "compat.choose_sign": "Choose your sign",
  "compat.more_precise_title": "Want 10x more precise analysis?",
  "compat.more_precise_desc": "Sun signs only cover 30% of your real dynamic. Complete synastry crosses the 10 planets and ascendants to reach 85% precision.",
  "compat.synastry_cta": "Complete synastry",
  "compat.oracle_q": "Analyse the compatibility between {s1} and {s2}: love, friendship and karma. What does it reveal about us?",
  "compat.oracle_cta": "Ask the Oracle",
...
const es: TranslationKeys = {
  ...
  "pricing.eveil_desc": "Perfil cósmico completo, 2 consultas al Oráculo al día, horóscopo diario",
  "pricing.etoile_name": "Estrella",
  "pricing.etoile_desc": "Oráculo ilimitado, memoria de conversaciones y guía mensual",
  ...
  "horoscope.personalised_cta_desc": "El horóscopo es una lectura general. Para una guía que tenga en cuenta tu carta astral completa, haz tu pregunta al Oráculo.",
  ...
  "signs.pisces": "Piscis",
  "compat.page_title": "Compatibilidad {s1} & {s2}",
  "compat.global_score": "Puntuación global",
  "compat.love": "Amor",
  "compat.friendship": "Amistad",
  "compat.work": "Trabajo",
  "compat.karma": "Karma",
  "compat.tension": "Tensión",
  "compat.strengths": "Fortalezas de esta combinación",
  "compat.frictions": "Puntos de fricción",
  "compat.guidance": "Guía kármica",
  "compat.method_title": "Método de cálculo",
  "compat.method_desc": "Cada compatibilidad se calcula a partir de los elementos (fuego, tierra, aire, agua - 60%) y las modalidades (cardinal, fijo, mutable - 40%) según la tradición astrológica helenística.",
  "compat.precision_note": "Este análisis da una visión general con ~30% de precisión. Para una precisión del 85%, una sinastría completa cruza los 10 planetas y los ascendentes de ambas cartas natales.",
  "compat.choose_sign": "Elige tu signo",
  "compat.more_precise_title": "¿Quieres un análisis 10 veces más preciso?",
  "compat.more_precise_desc": "Los signos solares solo cubren el 30% de tu dinámica real. La sinastría completa cruza los 10 planetas y los ascendentes hasta alcanzar el 85% de precisión.",
  "compat.synastry_cta": "Sinastría completa",
  "compat.oracle_q": "Analiza la compatibilidad entre {s1} y {s2}: amor, amistad y karma. ¿Qué revela sobre nuestra pareja?",
  "compat.oracle_cta": "Preguntar al Oráculo",
...
const pt: TranslationKeys = {
  ...
  "pricing.eveil_name": "Despertar",
  "pricing.eveil_desc": "Perfil cósmico completo, 2 consultas ao Oráculo por dia, horóscopo diário",
  "pricing.etoile_name": "Estrela",
  "pricing.etoile_desc": "Oráculo ilimitado, memória das conversas e orientação mensal",
  ...
  "horoscope.personalised_cta_desc": "O horóscopo é uma leitura geral. Para uma orientação que tenha em conta o teu mapa astral completo, pergunta ao Oráculo.",
  ...
  "signs.pisces": "Peixes",
  "compat.page_title": "Compatibilidade {s1} & {s2}",
  "compat.global_score": "Pontuação global",
  "compat.love": "Amor",
  "compat.friendship": "Amizade",
  "compat.work": "Trabalho",
  "compat.karma": "Karma",
  "compat.tension": "Tensão",
  "compat.strengths": "Pontos fortes desta combinação",
  "compat.frictions": "Pontos de atrito",
  "compat.guidance": "Orientação kármica",
  "compat.method_title": "Método de cálculo",
  "compat.method_desc": "Cada compatibilidade é calculada a partir dos elementos (fogo, terra, ar, água - 60%) e das modalidades (cardinal, fixo, mutável - 40%) segundo a tradição astrológica helenística.",
  "compat.precision_note": "Esta análise dá uma visão geral com ~30% de precisão. Para 85% de precisão, uma sinastria completa cruza os 10 planetas e os ascendentes de ambos os mapas natais.",
  "compat.choose_sign": "Escolhe o teu signo",
  "compat.more_precise_title": "Queres uma análise 10x mais precisa?",
  "compat.more_precise_desc": "Os signos solares só cobrem 30% da vossa dinâmica real. A sinastria completa cruza os 10 planetas e os ascendentes para chegar aos 85% de precisão.",
  "compat.synastry_cta": "Sinastria completa",
  "compat.oracle_q": "Analisa a compatibilidade entre {s1} e {s2}: amor, amizade e karma. O que revela sobre o nosso casal?",
  "compat.oracle_cta": "Perguntar ao Oráculo",
  "compat.free_calc_cta": "Calculadora gratuita",
...
const de: TranslationKeys = {
  ...
  "pricing.eveil_desc": "Vollständiges kosmisches Profil, 2 Orakel-Konsultationen pro Tag, tägliches Horoskop",
  "pricing.etoile_name": "Stern",
  "pricing.etoile_desc": "Unbegrenztes Orakel, Gesprächserinnerung und monatliche Begleitung",
  ...
  "horoscope.personalised_cta_desc": "Das Horoskop ist eine allgemeine Lesung. Für eine Führung mit deinem vollständigen Geburtshoroskop frage das Orakel.",
  ...
  "signs.pisces": "Fische",
  "compat.page_title": "Kompatibilität {s1} & {s2}",
  "compat.global_score": "Gesamtwert",
  "compat.love": "Liebe",
  "compat.friendship": "Freundschaft",
  "compat.work": "Arbeit",
  "compat.karma": "Karma",
  "compat.tension": "Spannung",
  "compat.strengths": "Stärken dieser Kombination",
  "compat.frictions": "Reibungspunkte",
  "compat.guidance": "Karmische Führung",
  "compat.method_title": "Berechnungsmethode",
  "compat.method_desc": "Jede Kompatibilität wird aus den Elementen (Feuer, Erde, Luft, Wasser - 60%) und den Modalitäten (kardinal, fest, veränderlich - 40%) nach der hellenistischen astrologischen Tradition berechnet.",
  "compat.precision_note": "Diese Analyse bietet einen Überblick mit ~30% Genauigkeit. Für 85% Genauigkeit kreuzt eine vollständige Synastrie die 10 Planeten und Aszendenten beider Geburtshoroskope.",
  "compat.choose_sign": "Wähle dein Zeichen",
  "compat.more_precise_title": "Möchtest du eine 10x genauere Analyse?",
  "compat.more_precise_desc": "Die Sonnenzeichen decken nur 30% eurer realen Dynamik ab. Die vollständige Synastrie kreuzt die 10 Planeten und Aszendenten, um 85% Genauigkeit zu erreichen.",
  "compat.synastry_cta": "Vollständige Synastrie",
  "compat.oracle_q": "Analysiere die Kompatibilität zwischen {s1} und {s2}: Liebe, Freundschaft und Karma. Was sagt das über uns aus?",
  "compat.oracle_cta": "Das Orakel fragen",
...
const it: TranslationKeys = {
  ...
  "pricing.eveil_desc": "Profilo cosmico completo, 2 consultazioni all'Oracolo al giorno, oroscopo quotidiano",
  "pricing.etoile_name": "Stella",
  "pricing.etoile_desc": "Oracolo illimitato, memoria delle conversazioni e guida mensile",
  ...
  "horoscope.personalised_cta_desc": "L'oroscopo è una lettura generale. Per una guida che tenga conto del tuo tema natale completo, fai la tua domanda all'Oracolo.",
  ...
  "signs.pisces": "Pesci",
  "compat.page_title": "Compatibilità {s1} & {s2}",
  "compat.global_score": "Punteggio globale",
  "compat.love": "Amore",
  "compat.friendship": "Amicizia",
  "compat.work": "Lavoro",
  "compat.karma": "Karma",
  "compat.tension": "Tensione",
  "compat.strengths": "Punti di forza di questa combinazione",
  "compat.frictions": "Punti di attrito",
  "compat.guidance": "Guida karmica",
  "compat.method_title": "Metodo di calcolo",
  "compat.method_desc": "Ogni compatibilità è calcolata dagli elementi (fuoco, terra, aria, acqua - 60%) e dalle modalità (cardinale, fisso, mutabile - 40%) secondo la tradizione astrologica ellenistica.",
  "compat.precision_note": "Questa analisi offre una panoramica con ~30% di precisione. Per l'85% di precisione, una sinastria completa incrocia i 10 pianeti e gli ascendenti di entrambi i temi natali.",
  "compat.choose_sign": "Scegli il tuo segno",
  "compat.more_precise_title": "Vuoi un'analisi 10 volte più precisa?",
  "compat.more_precise_desc": "I segni solari coprono solo il 30% della vostra dinamica reale. La sinastria completa incrocia i 10 pianeti e gli ascendenti per raggiungere l'85% di precisione.",
  "compat.synastry_cta": "Sinastria completa",
  "compat.oracle_q": "Analizza la compatibilità tra {s1} e {s2}: amore, amicizia e karma. Cosa rivela della nostra coppia?",
  "compat.oracle_cta": "Chiedi all'Oracolo",
...
const tr: TranslationKeys = {
  ...
  "pricing.eveil_desc": "Tam kozmik profil, günde 2 Kahin danışması, günlük burç",
  "pricing.etoile_name": "Yıldız",
  "pricing.etoile_desc": "Sınırsız Kahin, konuşma hafızası ve aylık rehberlik",
  ...
  "horoscope.personalised_cta_desc": "Burç genel bir okumadır. Tam doğum haritanı dikkate alan rehberlik için Kahin'e sor.",
  ...
  "signs.aquarius": "Kova",
  "signs.pisces": "Balık",
  "compat.page_title": "{s1} & {s2} Uyumluluğu",
  "compat.global_score": "Genel puan",
  "compat.love": "Aşk",
  "compat.friendship": "Arkadaşlık",
  "compat.work": "İş",
  "compat.karma": "Karma",
  "compat.tension": "Gerginlik",
  "compat.strengths": "Bu kombinasyonun güçlü yönleri",
  "compat.frictions": "Sürtüşme noktaları",
  "compat.guidance": "Karmik rehberlik",
  "compat.method_title": "Hesaplama yöntemi",
  "compat.method_desc": "Her uyumluluk, Helenistik astroloji geleneğine göre elementler (ateş, toprak, hava, su - %60) ve modalitelerden (öncü, sabit, değişken - %40) hesaplanır.",
  "compat.precision_note": "Bu analiz ~%30 doğrulukla genel bir bakış sunar. %85 doğruluk için, tam bir sinastri her iki doğum haritasının 10 gezegenini ve yükselenlerini çaprazlar.",
  "compat.choose_sign": "Burcunu seç",
  "compat.more_precise_title": "10 kat daha hassas bir analiz ister misin?",
  "compat.more_precise_desc": "Güneş burçları gerçek dinamiğinizin sadece %30'unu kapsar. Tam sinastri, 10 gezegeni ve yükselenleri çaprazlayarak %85 doğruluğa ulaşır.",
  "compat.synastry_cta": "Tam sinastri",
  "compat.oracle_q": "{s1} ve {s2} arasındaki uyumu analiz et: aşk, dostluk ve karma. Çiftimiz hakkında ne ortaya koyuyor?",
  "compat.oracle_cta": "Kâhine sor",
...
const pl: TranslationKeys = {
  ...
  "pricing.eveil_desc": "Pełny profil kosmiczny, 2 konsultacje Wyroczni dziennie, codzienny horoskop",
  "pricing.etoile_name": "Gwiazda",
  "pricing.etoile_desc": "Nielimitowana Wyrocznia, pamięć rozmów i comiesięczne wskazówki",
  ...
  "horoscope.personalised_cta_desc": "Horoskop to ogólna lektura. Aby uzyskać wskazówki uwzględniające pełny horoskop urodzeniowy, zapytaj Wyrocznię.",
  ...
  "signs.pisces": "Ryby",
  "compat.page_title": "Kompatybilność {s1} & {s2}",
  "compat.global_score": "Wynik ogólny",
  "compat.love": "Miłość",
  "compat.friendship": "Przyjaźń",
  "compat.work": "Praca",
  "compat.karma": "Karma",
  "compat.tension": "Napięcie",
  "compat.strengths": "Mocne strony tej kombinacji",
  "compat.frictions": "Punkty tarcia",
  "compat.guidance": "Wskazówka karmiczna",
  "compat.method_title": "Metoda obliczania",
  "compat.method_desc": "Każda kompatybilność jest obliczana na podstawie żywiołów (ogień, ziemia, powietrze, woda - 60%) i modalności (kardynalne, stałe, zmienne - 40%) zgodnie z hellenistyczną tradycją astrologiczną.",
  "compat.precision_note": "Ta analiza daje ogólny obraz z ~30% dokładnością. Dla 85% dokładności, pełna synastria krzyżuje 10 planet i ascendenty obu horoskopów urodzeniowych.",
  "compat.choose_sign": "Wybierz swój znak",
  "compat.more_precise_title": "Chcesz analizę 10 razy dokładniejszą?",
  "compat.more_precise_desc": "Znaki słoneczne pokrywają tylko 30% waszej rzeczywistej dynamiki. Pełna synastria krzyżuje 10 planet i ascendenty, osiągając 85% dokładności.",
  "compat.synastry_cta": "Pełna synastria",
  "compat.oracle_q": "Przeanalizuj zgodność między {s1} i {s2}: miłość, przyjaźń i karma. Co to mówi o naszej parze?",
  "compat.oracle_cta": "Zapytaj Wyrocznię",
...
const ru: TranslationKeys = {
  ...
  "pricing.eveil_desc": "Полный космический профиль, 2 консультации Оракула в день, ежедневный гороскоп",
  "pricing.etoile_name": "Звезда",
  "pricing.etoile_desc": "Безлимитный Оракул, память разговоров и ежемесячное руководство",
  ...
  "horoscope.personalised_cta_desc": "Гороскоп - это общее чтение. Для руководства с учётом полной натальной карты задай вопрос Оракулу.",
  ...
  "signs.pisces": "Рыбы",
  "compat.page_title": "Совместимость {s1} и {s2}",
  "compat.global_score": "Общий балл",
  "compat.love": "Любовь",
  "compat.friendship": "Дружба",
  "compat.work": "Работа",
  "compat.karma": "Карма",
  "compat.tension": "Напряжение",
  "compat.strengths": "Сильные стороны этой комбинации",
  "compat.frictions": "Точки трения",
  "compat.guidance": "Кармическое руководство",
  "compat.method_title": "Метод расчёта",
  "compat.method_desc": "Каждая совместимость рассчитывается на основе элементов (огонь, земля, воздух, вода - 60%) и модальностей (кардинальная, фиксированная, мутабельная - 40%) согласно эллинистической астрологической традиции.",
  "compat.precision_note": "Этот анализ даёт общий обзор с точностью ~30%. Для 85% точности полная синастрия пересекает 10 планет и асценденты обеих натальных карт.",
  "compat.choose_sign": "Выбери свой знак",
  "compat.more_precise_title": "Хочешь анализ в 10 раз точнее?",
  "compat.more_precise_desc": "Солнечные знаки охватывают только 30% вашей реальной динамики. Полная синастрия пересекает 10 планет и асценденты, достигая 85% точности.",
  "compat.synastry_cta": "Полная синастрия",
  "compat.oracle_q": "Проанализируй совместимость между {s1} и {s2}: любовь, дружба и карма. Что это говорит о нашей паре?",
  "compat.oracle_cta": "Спросить Оракула",
...
const ja: TranslationKeys = {
  ...
  "pricing.eveil_desc": "完全なコスミックプロフィール、1日2回のオラクル相談、毎日のホロスコープ",
  "pricing.etoile_name": "星",
  "pricing.etoile_desc": "無制限のオラクル、会話の記憶、毎月のガイダンス",
  ...
  "horoscope.personalised_cta_desc": "ホロスコープは一般的な占いです。完全な出生図を考慮したガイダンスはオラクルに質問してください。",
  ...
  "signs.aquarius": "水瓶座",
  "signs.pisces": "魚座",
  "compat.page_title": "{s1}と{s2}の相性",
  "compat.global_score": "総合スコア",
  "compat.love": "愛",
  "compat.friendship": "友情",
  "compat.work": "仕事",
  "compat.karma": "カルマ",
  "compat.tension": "緊張",
  "compat.strengths": "この組み合わせの強み",
  "compat.frictions": "摩擦点",
  "compat.guidance": "カルマ的ガイダンス",
  "compat.method_title": "計算方法",
  "compat.method_desc": "各相性は、ヘレニズム占星術の伝統に従って、エレメント（火、地、風、水 - 60%）とモダリティ（活動宮、不動宮、柔軟宮 - 40%）から計算されます。",
  "compat.precision_note": "この分析は~30%の精度で全体像を示します。85%の精度のために、完全なシナストリーは2つの出生図の10惑星とアセンダントを交差させます。",
  "compat.choose_sign": "あなたの星座を選ぶ",
  "compat.more_precise_title": "10倍精密な分析が欲しい？",
  "compat.more_precise_desc": "太陽星座はあなたの実際のダイナミクスの30%しかカバーしません。完全なシナストリーは10惑星とアセンダントを交差させ、85%の精度に達します。",
  "compat.synastry_cta": "完全なシナストリー",
  "compat.oracle_q": "{s1}と{s2}の相性を分析して：愛、友情、カルマ。私たちについて何がわかる？",
  "compat.oracle_cta": "オラクルに尋ねる",
...
const ar: TranslationKeys = {
  ...
  "pricing.eveil_desc": "ملف كوني كامل، استشارتان مع العرّاف يومياً، برج يومي",
  "pricing.etoile_name": "النجم",
  "pricing.etoile_desc": "عرّاف غير محدود، ذاكرة للمحادثات وإرشاد شهري",
  ...
  "horoscope.personalised_cta_desc": "البرج قراءة عامة. للحصول على إرشاد يأخذ خريطة ميلادك الكاملة في الاعتبار، اسأل العرّاف.",
  ...
  "signs.pisces": "الحوت",
  "compat.page_title": "توافق {s1} & {s2}",
  "compat.global_score": "النتيجة الإجمالية",
  "compat.love": "الحب",
  "compat.friendship": "الصداقة",
  "compat.work": "العمل",
  "compat.karma": "الكارما",
  "compat.tension": "التوتر",
  "compat.strengths": "نقاط قوة هذه التركيبة",
  "compat.frictions": "نقاط الاحتكاك",
  "compat.guidance": "إرشاد كرمي",
  "compat.method_title": "طريقة الحساب",
  "compat.method_desc": "يتم حساب كل توافق من العناصر (نار، تراب، هواء، ماء - 60%) والأنماط (أساسي، ثابت، متغير - 40%) وفقًا للتقليد التنجيمي الهلنستي.",
  "compat.precision_note": "يقدم هذا التحليل نظرة عامة بدقة ~30%. لدقة 85%، يقطع التوافق الكامل الكواكب العشرة والطوالع لكلا الخريطتين الفلكيتين.",
  "compat.choose_sign": "اختر برجك",
  "compat.more_precise_title": "هل تريد تحليلاً أكثر دقة 10 مرات؟",
  "compat.more_precise_desc": "تغطي الأبراج الشمسية فقط 30% من ديناميكيتكم الحقيقية. يعبر التوافق الكامل الكواكب العشرة والطوالع ليصل إلى دقة 85%.",
  "compat.synastry_cta": "توافق كامل",
  "compat.oracle_q": "حلّل التوافق بين {s1} و{s2}: الحب والصداقة والكارما. ماذا يكشف عن علاقتنا؟",
  "compat.oracle_cta": "اسأل العرّاف",
