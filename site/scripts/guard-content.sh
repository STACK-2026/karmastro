...
# public site.
node --test "$HERE/test-blog-fragments.mjs" "$HERE/test-blog-contrast.mjs" "$HERE/test-app-content-links.mjs" "$HERE/test-cta-funnel.mjs" "$HERE/test-guard-fail-closed.mjs" "$HERE/test-oracle-acquisition-v1.mjs" "$HERE/test-seo-technical-contract.mjs" "$HERE/test-seo-geo-content-contract.mjs"
